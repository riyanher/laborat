                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h3 text-primary mb-4"><i class="fas fa-fw fa-flask rotate-n-15"></i> Lab Elektro</h1>
                                </div>
                                <div class="text-center">
                                ...
                                <form class="user" method="post" action="<?= base_url('autentifikasi'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="password" placeholder="Maukkan Password" name="password">
